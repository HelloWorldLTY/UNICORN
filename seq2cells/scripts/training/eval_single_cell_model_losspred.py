...
from seq2cells.models.embedding2targetlosspred import Embedding2Target
...
#     losspred = model.losspred(torch.FloatTensor(predictions))
    losspred = model.losspred(torch.FloatTensor(adata.obsm['seq_embedding'].values))
    adata.obsm['pred_loss'] = losspred.detach().numpy()
